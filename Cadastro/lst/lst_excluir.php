...
<div class="base-home">
    ...
    <div class="base-lista">
                    ...
                    foreach ($clientes as $cliente) {
                        ...
                        <tbody>
                            <tr class="cor1">
                                ...
                                <td align="center">
                                    <a href="<?php echo 'index.php?link=2&acao=Excluir&id=' . $cliente['id_cliente'] ?>" class="btn">Excluir</a>
                                </td>
                                <?php
                            }
                        } else {
        ...
        <ul class="paginacao">
            <?php echo paginacao("index.php?link=5", $paginas, $total_paginas, $pg); //Imprime as opçoes para mudar mudar as pagina   ?>
        </ul>
    </div>
</div>